...
const MiniNavBar = ({ activeOption, onOptionChange }) => {
    ...
    const navOptions = [
        { id: "find-agent", label: "Find Agent", icon: <UserSearch size={22} /> },
        { id: "file-ready", label: "File Ready", icon: <FileCheck size={22} /> },
        { id: "apply-visa", label: "Apply Visa", icon: <Stamp size={22} /> },
        { id: "travel-guide", label: "Tour Guide", icon: <Compass size={22} /> },
        { id: "insurance", label: "Insurance", icon: <ShieldCheck size={22} /> },
        { id: "rent-a-car", label: "Book Car", icon: <CarFront size={22} /> },
        { id: "book-hotels", label: "Hotels", icon: <Hotel size={22} /> },
    ];
              ...
              "
                        >
                            <span className="text-2xl mb-2">
                                {isExpanded ? <ChevronUp size={24} /> : <Rocket size={24} />}
                            </span>
