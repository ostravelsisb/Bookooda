            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-[68px] items-center gap-4">
                    ...
                    >
                        ...
                        />
                        <span className="font-black text-[18px] tracking-tight leading-none text-blue-600 transition-all duration-300 group-hover:text-blue-700" style={{ fontFamily: 'Poppins, sans-serif' }}>
